...
administration <- tabPanel("ADMINISTRATION",
                           br(), br(),
                                                       ...
                                                       content = tags$div(
                                                         div(id = "edit_user_info_Form",
                                                            fluidRow(
                                                              column(12,
                                                               column(3, offset = 1,
                                                                      uiOutput("edit_user_info_UserName_Output")
                                                                      ),
                                                               column(8)),
                                                               
                                                               column(3,offset = 4,
                                                                      actionBttn("edit_user_info_DisplayUserInfo", "Display User Information", style = "jelly", color = "primary", size = "sm", block = T)
                                                               )),br(),br(),
                                                            fluidRow(
                                                                 column(4, offset = 1,
                                                            ...
                                                            fluidRow(
                                                               column(10, offset = 1,
                                                                 column(3,
                                                                        actionBttn("edit_user_info_UpdateUserInfo", "Update User Information", color = "primary", style = "jelly", block = T, size="xs")),
                                                                 column(3,
                                                                        actionBttn("edit_user_info_DeleteUser", "Delete User", color = "primary", style = "jelly", block = T, size="xs")),
                                                                 column(3,
                                                                        actionBttn("edit_user_info_ResetPassword", "Reset Password", color = "primary", style = "jelly", block = T, size="xs")),
                                                                 column(3,
                                                                        actionBttn("edit_user_info_ClearForm", "Clear Form", color = "primary", style = "jelly", block = T, size="xs"))
                                                               )
                                                            )
                                                             )
                                                         )
