...
new_cell_suspension_culture <- 
  tabPanel("New CSC", value = "new_CSC",
           ...
           div(id = "new_CSC_form",
                 ...
                 column(12,
                        ...
                        column(4, offset = 2,
                               conditionalPanel(condition = "input.new_CSC_ReadyToCulture=='Yes'",
                                                ...
                                                selectInput("new_CSC_CulturedBy", labelMandatory("Cultured By"), choices = NULL),
               ...
               fluidRow(
                 column(4,
                        ...
                        column(6, selectInput("new_CSC_Media", "", choices = NULL, multiple = F)),
                        
                        column(5, br(), tags$b("Additives")),
                        column(6, selectInput("new_CSC_Additives", "", choices =  NULL, multiple = T)),
           ...
           fluidRow(
             column(6),
             column(6,
                    column(3, offset = 4, actionBttn("new_CSC_FormToPicture", "Form to Picture", style = "jelly", size = "xs", color = "success", block=T)),
                    column(3, actionBttn("new_CSC_ControlForm", "Control Form", style = "jelly", size = "xs", color = "warning", block=T)),
                    column(2, actionBttn("new_CSC_Exit", "Exit", style = "jelly", size = "xs", color = "danger", block=T))
             )
           )
  )
