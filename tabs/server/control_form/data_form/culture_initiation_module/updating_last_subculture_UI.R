...
tabPanel("Updating Last Subculture", value = "updating_last_subculture",
          ...
          div(id = "updating_last_subculture_Form",       
                 fluidRow(
                   column(10,offset = 1,
                       column(4,
                              uiOutput("updating_last_subculture_CultureInitiationIdentity_Output")
                             ),
                 ...
                 fluidRow(
                    ...
                    column(6,
                           column(4),
                           column(3, actionBttn("updating_last_subculture_FormToPicture", "Form to Picture", style = "jelly", size = "xs", color = "success", block=T)),
                           column(3, actionBttn("updating_last_subculture_MFC_SCP_CSC_ControlForm", "Control Form", style = "jelly", size = "xs", color = "warning", block=T)),
                           column(2, actionBttn('updating_last_subculture_Exit', "Exit", style = "jelly", size = "xs", color = "danger", block=T))
                          )
                 )
)