...
search_culture_initiation <- tabPanel("Search Culture Initiation", value = "search_culture_initiation",
                                      br(),br(),
                                      useShinyjs(),
                                  ...
                                  div(id = "search_culture_initiation_Form",     
                                      ...
                                      fluidRow(
                                        ...
                                        column(8,
                                               ...
                                               #                   choices = c("Search","Clear Form", "Culture", "Delete Selected MFC"),individual = TRUE, size ="sm", status = "info",
                                      ...
                                      fluidRow(
                                        ...
                                        column(4, br(), awesomeCheckbox(inputId = "search_culture_initiation_SearchDeletedMFC", label = "Search Deleted MFC", status = "info", value = FALSE),
                                      ...
                                      fluidRow(br(),hr(),
                                        column(8, offset = 2,
                                               column(2, actionBttn("search_culture_initiation_FormToPicture", "Form to Picture", style = "jelly", size = "sm", color = "primary", block=T)),
                                               column(4, actionBttn("search_culture_initiation_MFC_SCP_CSC_ControlForm", "MFC, SCP and CSC Control Form", style = "jelly", size = "sm", color = "primary", block=T)),
                                               column(2, actionBttn("search_culture_initiation_Exit", "Exit", style = "jelly", size = "sm", color = "primary", block=T))
